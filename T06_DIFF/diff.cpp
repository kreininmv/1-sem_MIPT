...
int mk5::differenciator::love_math(char *expr, char *var) {
  ...
  memcpy(command, &ZERO, COMMAND_LEN);
  strcat(command, "W:\\MIPT\\Programming\\T06DIFF\\T06DIFF\\iconv\\iconv.exe -t UTF-8 -f CP1251 < W:\\MIPT\\Programming\\T06DIFF\\T06DIFF\\");
  strcat(command, file_name);
  strcat(command, " > W:\\MIPT\\Programming\\T06DIFF\\T06DIFF\\temp_");
  strcat(command, file_name);
